...
![Печатная плата с двумя тактовыми кнопками](img/notes/slider-button-plate.png)

![Кнопки и концевик встроены в переднюю панель](img/notes/slider-buttons-mount.png)

Подключил энкодер и все кнопки, прошил тестовый экран — видно, что всё откликается: энкодер крутится, концевики срабатывают.

![Собранная верхняя панель с экраном в режиме Input test](img/notes/slider-input-test.png)
...
![Батарейный отсек с тремя аккумуляторами в руке](img/notes/slider-battery-holder.png)

На отсек присобачил простенькую плату BMS, которая раньше использовалась в другом проекте — думаю, пока её тут хватит.

![Плата BMS и разводка проводов внутри корпуса](img/notes/slider-bms.png)
