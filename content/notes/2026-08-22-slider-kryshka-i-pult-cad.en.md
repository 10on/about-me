...
![The slider mounted on a tripod head with the electronics case clamped in place: the screen shows the Camera Slider menu, IDLE, 56%](img/notes/slider-mounted-working.webp)

Also still working on the remote, here's where it's at.

![CAD model of the remote's case: an elongated lid with a cutout for the screen and five holes for buttons, next to a perforated back panel](img/notes/remote-case-cad.webp)
